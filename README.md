...
| **SV3 (Thành viên)** | **Phạm Phú Nguyễn Hưng** | `26730023` | [`26730023-PhamPhuNguyenHung`]([https://github.com/hungpixi](https://github.com/26730023-PhamPhuNguyenHung)) | `An-Moi` | Xử lý logic sinh mồi ngẫu nhiên (`Point Qua`), cơ chế rắn ăn mồi tăng độ dài và tính điểm thời gian thực |
